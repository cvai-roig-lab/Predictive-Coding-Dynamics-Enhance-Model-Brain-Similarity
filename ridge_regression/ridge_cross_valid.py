...
def train_Ridgeregression_per_ROI(trn_x,tst_x,trn_y,tst_y):
    ...
    #tst_y_1,tst_y_2 = np.split(tst_y,2)
...
def Ridge_Encoding(feat_path, roi_path, model_name, trn_tst_split=0.8, n_folds=3, n_components=100, batch_size=100, just_corr=True, return_correlations = False,random_state=14, save_path="Linear_Encoding_Results"):
    """
...
def _ridge_encoding(feat_path, roi_path, model_name, trn_tst_split=0.8, n_folds=3, n_components=100, batch_size=100, just_corr=True, return_correlations = False,random_state=14):
    """
    Perform linear encoding analysis to relate model activations to fMRI data across multiple folds.
        ...
        for layer_id in layer_list:
            ...
            for roi_path in roi_paths:
                ...
                for roi_file in roi_files:
                    ...
                    noise_ceiling = calculate_noise_ceiling(fmri_tst)
